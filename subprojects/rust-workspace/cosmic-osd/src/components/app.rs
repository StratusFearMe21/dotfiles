use cosmic::{iced::window::Id as SurfaceId, iced_style::application};
use iced::{
    wayland::{
...
use iced_sctk::{commands::layer_surface::destroy_layer_surface, settings::InitialSurface};
...
impl Application for App {
    ...
    fn new(_flags: ()) -> (Self, Command<Msg>) {
        (Self::default(), destroy_layer_surface(SurfaceId(0)))
    }
