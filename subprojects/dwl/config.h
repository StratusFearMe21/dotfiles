...
#define TAGKEYS(KEY, SKEY, TAG)                                                \
  {1, 0, KEY, view, {.ui = 1 << TAG}},                                         \
    ...
    1, WLR_MODIFIER_CTRL | WLR_MODIFIER_SHIFT, SKEY, toggletag, {              \
      .ui = 1 << TAG                                                           \
    }                                                                          \
  }
...
#define TAGKEYSALT(KEY, SKEY, TAG)                                             \
  ...
  {                                                                            \
    1, WLR_MODIFIER_CTRL | WLR_MODIFIER_SHIFT | WLR_MODIFIER_ALT, SKEY,        \
        toggletag, {                                                           \
      .ui = 1 << TAG                                                           \
    }                                                                          \
  }
...
static const Key keys[] = {
    ...
    {1,
     ...
     XKB_KEY_space,
     wob,
     {.w = ZNET_TAPESOFTWARE_DWL_WM_V1_WOB_COMMAND_LAUNCH_APP}},
    {1,
     0,
     XKB_KEY_p,
     wob,
    ...
    {1,
     ...
     XKB_KEY_Return,
     wob,
     {.w = ZNET_TAPESOFTWARE_DWL_WM_V1_WOB_COMMAND_LAUNCH_BROWSER}},
    {0,
     0,
     XKB_KEY_XF86AudioRaiseVolume,
     wob,
     {.w = ZNET_TAPESOFTWARE_DWL_WM_V1_WOB_COMMAND_VOLUME_UP}},
    {0,
     0,
     XKB_KEY_XF86AudioLowerVolume,
     wob,
     {.w = ZNET_TAPESOFTWARE_DWL_WM_V1_WOB_COMMAND_VOLUME_DOWN}},
    ...
    {0,
     ...
     wob,
     {.w = ZNET_TAPESOFTWARE_DWL_WM_V1_WOB_COMMAND_LIGHT_UP}},
    {0,
     0,
     XKB_KEY_XF86MonBrightnessDown,
     wob,
     {.w = ZNET_TAPESOFTWARE_DWL_WM_V1_WOB_COMMAND_LIGHT_DOWN}},
...
#define CHVT(n)                                                                \
  {                                                                            \
    0, WLR_MODIFIER_CTRL | WLR_MODIFIER_ALT, XKB_KEY_XF86Switch_VT_##n, chvt,  \
    {                                                                          \
      .ui = (n)                                                                \
    }                                                                          \
  }
